...
void sd_spi_init(void)
{
  ...
  sd_gpio_init.GPIO_Pin   = GPIO_Pin_SPI_SD_CS;
  sd_gpio_init.GPIO_Mode  = GPIO_Mode_Out_PP;
  sd_gpio_init.GPIO_Speed = GPIO_Speed_50MHz;
  ...
  sd_gpio_init.GPIO_Pin   = GPIO_Pin_SPI_SD_SCK | GPIO_Pin_SPI_SD_MOSI;
  sd_gpio_init.GPIO_Speed = GPIO_Speed_50MHz;
  sd_gpio_init.GPIO_Mode  = GPIO_Mode_AF_PP;
  GPIO_Init(GPIO_SPI_SD, &sd_gpio_init);
  /* Configure MISO as Input with internal pull-up */
  sd_gpio_init.GPIO_Pin   = GPIO_Pin_SPI_SD_MISO;
  sd_gpio_init.GPIO_Mode  = GPIO_Mode_IPU;
  GPIO_Init(GPIO_SPI_SD, &sd_gpio_init);
#else
  /* Configure I/O for Flash Chip select */
  sd_gpio_init.GPIO_Mode = GPIO_Mode_OUT;
  sd_gpio_init.GPIO_OType = GPIO_OType_PP;
  sd_gpio_init.GPIO_Pin = GPIO_Pin_SPI_SD_CS;
  sd_gpio_init.GPIO_PuPd = GPIO_PuPd_NOPULL;
  sd_gpio_init.GPIO_Speed = GPIO_Speed_50MHz;
  GPIO_Init(GPIO_SPI_SD_CS, &sd_gpio_init);
  
  /* Configure SPI pins: SCK and MOSI with default alternate function (not re-mapped) push-pull */
  sd_gpio_init.GPIO_Mode = GPIO_Mode_AF;
  sd_gpio_init.GPIO_OType = GPIO_OType_PP;
  sd_gpio_init.GPIO_Pin = GPIO_Pin_SPI_SD_SCK | GPIO_Pin_SPI_SD_MOSI;;
  sd_gpio_init.GPIO_PuPd = GPIO_PuPd_NOPULL;
  sd_gpio_init.GPIO_Speed = GPIO_Speed_50MHz;
  ...
  /* Configure MISO as Input with internal pull-up */
  sd_gpio_init.GPIO_Pin   = GPIO_Pin_SPI_SD_MISO;
  sd_gpio_init.GPIO_Mode  = GPIO_Mode_IN;
  sd_gpio_init.GPIO_PuPd = GPIO_PuPd_UP;
  GPIO_Init(GPIO_SPI_SD, &sd_gpio_init);
#endif
