...
#define T_SGPU_REGISRERS_VER "sGPU registers: v0.0.6"
...
// ------------------ General ----------------- //
#define BSY_SELECT        0xFC
#define CMD_GPU_PING      0xFD
#define CMD_GPU_SW_RESET  0xFE
