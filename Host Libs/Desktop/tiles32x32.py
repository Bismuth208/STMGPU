...
def testDrawTiles():
    ...
    for i in range(TEST_SAMPLE_SIZE):
        ...
        gpu.drawTile32x32(rndPosX, rndPosY, randrange(0, MAX_TILES, 1))
...
def fillScreenByTiles():
    maxXSize = int(gpu.width() / TLE_32X32_SIZE)  # \__ calculate how much
    maxYSize = int(gpu.height() / TLE_32X32_SIZE) # /   tiles in x and y axis
