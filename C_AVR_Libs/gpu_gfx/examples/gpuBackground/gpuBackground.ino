...
void gpuLoadTiles(void)
{
  ...
  // 9 - is width of tileSet in tiles ( 7 tiles width == 72 pixels)
...
void drawRamTileSet8x8(void)
{
  ...
  // draw 35 tiles
  for(uint8_t countY =0; countY <5; countY++) {
    for(uint8_t countX =0; countX <7; countX++) {
